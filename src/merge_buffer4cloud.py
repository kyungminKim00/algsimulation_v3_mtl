...
buffer_names = [
    buffer_name for buffer_name in file_names if ".pkl" and "buffer_" in buffer_name
]
buffer = None
total_samples = None
...
writeFile(
    "{}/cloud_buffer_E{}_S{}_U{}".format(
        target_folder, RUNHEADER.m_n_cpu, RUNHEADER.m_n_step, total_samples
    ),
    buffer,
)
