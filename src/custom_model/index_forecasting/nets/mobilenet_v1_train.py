...
flags.DEFINE_integer(
    "number_of_steps", None, "Number of training steps to perform before stopping"
)
...
flags.DEFINE_string(
    "fine_tune_checkpoint", "", "Checkpoint from which to start finetuning."
)
flags.DEFINE_string(
    "checkpoint_dir", "", "Directory for writing training checkpoints and logs"
)
...
def imagenet_input(is_training):
    ...
    if is_training:
        ...
        dataset = dataset_factory.get_dataset(
            "imagenet", "validation", FLAGS.dataset_dir
        )
...
def get_checkpoint_init_fn():
    ...
    if FLAGS.fine_tune_checkpoint:
        ...
        slim_init_fn = slim.assign_from_checkpoint_fn(
            FLAGS.fine_tune_checkpoint, variables_to_restore, ignore_missing_vars=True
        )
