...
def nature_cnn(scaled_images, is_training=False, **kwargs):
    ...
    layer_1_1 = conv(scaled_images_1, 'c1_1', n_filters=32, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME',
                     **kwargs)
    ...
    layer_2_1 = activ(conv(layer_1_1, 'c2_1', n_filters=64, filter_size=3, stride=2, init_scale=np.sqrt(2), pad='SAME',
    ...
    layer_1_2 = conv(scaled_images_2, 'c1_2', n_filters=32, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME',
                     **kwargs)
    ...
    layer_2_2 = activ(conv(layer_1_2, 'c2_2', n_filters=64, filter_size=3, stride=2, init_scale=np.sqrt(2), pad='SAME',
                           stride_method='Custom', **kwargs))
    ...
    layer_1_3 = conv(scaled_images_3, 'c1_3', n_filters=32, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME',
                     **kwargs)
    ...
    layer_2_3 = activ(conv(layer_1_3, 'c2_3', n_filters=64, filter_size=3, stride=2, init_scale=np.sqrt(2), pad='SAME',
                           stride_method='Custom', **kwargs))
    ...
    layer_1_4 = conv(scaled_images_4, 'c1_4', n_filters=32, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME',
                     **kwargs)
    ...
    layer_2_4 = activ(conv(layer_1_4, 'c2_4', n_filters=64, filter_size=3, stride=2, init_scale=np.sqrt(2), pad='SAME',
                           stride_method='Custom', **kwargs))
    ...
    layer_3 = tf.concat([layer_2_1, layer_2_2, layer_2_3, layer_2_4], name='channel_concat', axis=3)
