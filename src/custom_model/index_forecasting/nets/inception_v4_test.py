...
class InceptionTest(tf.test.TestCase):
    def testBuildLogits(self):
        ...
        self.assertListEqual(
            predictions.get_shape().as_list(), [batch_size, num_classes]
        )
    ...
    def testBuildWithoutAuxLogits(self):
        ...
        num_classes = 1000
        inputs = tf.random.uniform((batch_size, height, width, 3))
        logits, endpoints = inception.inception_v4(
    ...
    def testGlobalPool(self):
        ...
        self.assertListEqual(logits.get_shape().as_list(), [batch_size, num_classes])
        pre_pool = end_points["Mixed_7d"]
        self.assertListEqual(pre_pool.get_shape().as_list(), [batch_size, 9, 11, 1536])
    ...
    def testNoBatchNormScaleByDefault(self):
        ...
        with tf_slim.arg_scope(inception.inception_v4_arg_scope()):
    ...
    def testBatchNormScale(self):
        ...
        num_classes = 1000
        inputs = tf.compat.v1.placeholder(tf.float32, (1, height, width, 3))
        with tf_slim.arg_scope(inception.inception_v4_arg_scope(batch_norm_scale=True)):
            inception.inception_v4(inputs, num_classes, is_training=False)
