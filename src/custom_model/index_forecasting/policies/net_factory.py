...
def net_factory():
    ...
    # Dummy batch_normalization: off, regularization: off
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_Dummy import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_D import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: off, regularization: off (Not implemented yet)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_E import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: on
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_F import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: L1 -D v1 (Stem Sparse 512)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_L1 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: L1 -D v1 (Stem Sparse 512)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_L2 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: L1 -D v1 (Stem Sparse 512)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_L2_2 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512) - input feature experimental
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_T1 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512) - input feature experimental
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_T2 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512) - input feature experimental
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_T3 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512) - input feature experimental
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_T4 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 512, Reduced Res) - input feature experimental
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_G_T5 import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v1 (Stem Sparse 1024)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_H import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v2 (Stem Sparse 1024, late concat)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_I import (
            inception_resnet_v2,
        )
    ...
    # batch_normalization: on, regularization: off -D v2 (Stem Sparse 512, late concat)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_I_B import (
            inception_resnet_v2,
        )
    ...
    # (Not implemented yet)
        ...
        from custom_model.index_forecasting.nets.inception_resnet_v2_IF_J import (
            inception_resnet_v2,
        )
    ...
    # (Not implemented yet)
        ...
        RUNHEADER.default_net == "shake_regulization_v5"
    ):  # revise v3 - self attention part
        ...
        default_cnn = shakenet
    elif RUNHEADER.default_net == "shake_regulization_v7":  # Total markets
        from custom_model.index_forecasting.nets.shake_regulization_v7 import shakenet
