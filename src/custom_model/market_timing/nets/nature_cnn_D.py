...
def nature_cnn(scaled_images, is_training = False, **kwargs):
    ...
    layer_1_1 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_1_1, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_2_1 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_2_1, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_3_1 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_3_1, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_1_2 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_1_2, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_2_2 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_2_2, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_3_2 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_3_2, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_1_3 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_1_3, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_2_3 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_2_3, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    layer_3_3 = tf.compat.v1.layers.batch_normalization(
        inputs=layer_3_3, momentum=0.997, epsilon=1e-5, fused=True, training=is_training, scale=False)
    ...
    #     inputs=layer_3_4, momentum=0.997, epsilon=1e-5, fused=True, training=is_training)
