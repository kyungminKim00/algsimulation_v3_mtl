...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs, observation_space, action_space, observation_space_mt, action_space_mt):
        self.num_envs = num_envs
        self.observation_space = observation_space
        self.action_space = action_space
        self.observation_space_mt = observation_space_mt
        self.action_space_mt = action_space_mt
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(self, venv, observation_space=None, action_space=None, observation_space_mt=None, action_space_mt=None):
        self.venv = venv
        VecEnv.__init__(self, num_envs=venv.num_envs, 
        observation_space=observation_space or venv.observation_space,
                        action_space=action_space or venv.action_space,
                        observation_space_mt=observation_space_mt or venv.observation_space_mt,
                        action_space_mt=action_space_mt or venv.action_space_mt)
