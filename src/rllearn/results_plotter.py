...
from rllearn.bench.monitor import load_results
...
def plot_curves(xy_list, xaxis, title):
    ...
    for (i, (x, y)) in enumerate(xy_list):
        ...
        x, y_mean = window_func(
            x, y, EPISODES_WINDOW, np.mean
        )  # So returns average of last EPISODE_WINDOW episodes
...
def main():
    ...
    .. code-block:: python
        ...
        from rllearn import log_viewer
        %matplotlib inline
