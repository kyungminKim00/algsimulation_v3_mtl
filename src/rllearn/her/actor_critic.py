...
from rllearn.her.util import mlp
...
class ActorCritic:
    def __init__(self, inputs_tf, dim_obs, dim_goal, dim_action,
        ...
        :param o_stats (rllearn.her.Normalizer): normalizer for observations
        :param g_stats (rllearn.her.Normalizer): normalizer for goals
