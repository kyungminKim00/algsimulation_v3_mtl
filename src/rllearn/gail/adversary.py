...
class TransitionClassifier(object):
    ...
    def build_ph(self):
        ...
        build placeholder
        """
        self.generator_obs_ph = tf.compat.v1.placeholder(tf.float32, (None,) + self.observation_shape,
                                               name="observations_ph")
        self.generator_acs_ph = tf.compat.v1.placeholder(tf.float32, (None,) + self.actions_shape,
                                               name="actions_ph")
        self.expert_obs_ph = tf.compat.v1.placeholder(tf.float32, (None,) + self.observation_shape,
                                            name="expert_observations_ph")
        self.expert_acs_ph = tf.compat.v1.placeholder(tf.float32, (None,) + self.actions_shape,
