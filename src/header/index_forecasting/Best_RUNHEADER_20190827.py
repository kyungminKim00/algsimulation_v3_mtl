...
m_dataset_dir = (
    "./save/tf_record/index_forecasting/if_x0_20_y20_" + dataset_version
)  # data set location
m_cv_number = 0

# agent opt
m_name = "IF_MCL_Vceof1_picoef001_LR1E3_GraClip_FOb_NCA"  # Caution: at first, this directory would be deleted and then re-created
...
default_net = "nature_cnn_A"  # [ 'nature_cnn_A' | 'nature_cnn_B' | 'inception_resnet_v2_A' | 'inception_resnet_v2_B']
...
"""
m_buffer_size = int(
    m_total_example * 0.2 * m_n_cpu * m_n_step
...
m_pre_train_model = "./save/model/rllearn/IF_v0_SP_VL1_VnraNet_NGraClip_FOb_NCA_LR_Buffer/fs_epoch_53_0_pe3.21e-06_pl-6.83e+03_vl4.85.pkl"
m_offline_buffer_file = (
    "./save/model/rllearn/buffer_save/IF_v0_SP_VL1_VnraNet_NGraClip_FOb"
)
if m_train_mode == 1:
