...
def main(_):
    FLAGS.s_test = None if FLAGS.s_test == "None" else FLAGS.s_test
    FLAGS.e_test = None if FLAGS.e_test == "None" else FLAGS.e_test
...
if __name__ == "__main__":
    try:
        ...
        # parser.add_argument("--verbose", type=int, default=None)
        # parser.add_argument(
        #     "--m_target_index", type=int, default=1
        # )  # [0 | 1 | 2 | ~ | 14]
        # parser.add_argument(
        ...
        # parser.add_argument("--performed_date", type=str, default=datetime.now().strftime('%Y-%m-%d %H:%M:%S'))

        # # Debug parameter v1 - generate traing/test data (experimental)
    ...
    #     dataset_version = f"if_x0_20_y{args.forward_ndx}_{RUNHEADER.dataset_version}"
    # tf.compat.v1.app.flags.DEFINE_string(
    #     "dataset_name", dataset_version, "Data set name"
    # )
