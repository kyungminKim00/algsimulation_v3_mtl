...
features_description = {
    "structure/data": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    ...
    "structure/data_ma5": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/data_ma10": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/data_ma20": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/data_ma60": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/normal": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/normal_ma5": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/normal_ma10": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/normal_ma20": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/normal_ma60": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/diff": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/diff_ma5": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/diff_ma10": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/diff_ma20": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    "structure/diff_ma60": tf.io.FixedLenFeature(
        [x_seq, num_structure_variables], tf.float32
    ),
    ...
    "structure/class/seq_ratio": tf.io.FixedLenFeature(
        [forecast, num_fund], tf.float32
    ),
