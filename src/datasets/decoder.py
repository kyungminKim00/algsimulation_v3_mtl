...
def pkexample_type_original(
    ...
    patch_historical_ar,
    patch_historical_ar_ma5,
    patch_historical_ar_ma10,
    ...
    feature = {
        ...
        #     reshape((g_num_of_datatype_obs, g_x_seq, g_x_variables)),
        "structure/predefined_observation_total": np.concatenate(
            (
                patch_sd.normal_data,  # 0
                patch_sd_ma5.normal_data,
                patch_sd_ma10.normal_data,
                patch_sd_ma20.normal_data,
...
def pkexample_type_B(
    ...
    *args
    ...
    feature = {
        ...
        #     (
        #         patch_historical_ar.normal_data,  # 0
        ...
        #     ),
        #     axis=0,
        # ).reshape((args[1], patch_historical_ar.normal_data.shape[0], 1)),
        # # Todo: apply MlpLnlstm, later on
        # 'structure/predefined_observation_extra_cov': patch_extra_cov_60.data.reshape(
        #     (1, patch_extra_cov_60.data.shape[0], patch_extra_cov_60.data.shape[1])),
        # 'structure/class/seq_price': patch_sd.class_seq_price,
                ...
                np.broadcast_to(
                    np.concatenate(
                        (
                            ...
                            # patch_sd_ma20.normal_data,
                            # patch_sd_ma60.normal_data,
                            patch_sd_diff.cumulative_sum_data,  # 5
                            patch_sd_diff_ma5.cumulative_sum_data,
                            patch_sd_diff_ma10.cumulative_sum_data,
                            patch_sd_diff_ma20.cumulative_sum_data,
                            patch_sd_diff_ma60.cumulative_sum_data,
                            # patch_sd_velocity.data
                            # + patch_sd.normal_data,  # 10 [spread - grained]
                            # patch_sd_velocity_ma5.data + patch_sd_ma5.normal_data,
                            # patch_sd_velocity_ma10.data + patch_sd_ma10.normal_data,
